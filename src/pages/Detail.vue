<template>
  ...
  <div v-if="product" class="text-center mb-6">
    ...
    <p class="text-lg text-stone-700 font-semibold mb-4">Price :{{ product.numPrice }}</p>

  </div>
  <div v-if="product">
  <p class="text-stone-600 text-center max-w-prose mx-auto">{{ product.description }}</p>
   </div>
  <div v-else>
    Loading...
  </div>
